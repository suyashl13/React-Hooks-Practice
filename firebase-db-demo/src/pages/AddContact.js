...
const AddContact = () => {
  ...
  const imagePicker = async e => {
    ...
    try {
      ...
      uploadTask.on(
        ...
        error => 
        toast("Something wrong in state change", {
          type:"error"
        }),
        ()=>{
  ...
  const addContact = async () => {
    ...
    try {
      ...
      .set(
        {
          name: name, email :email, phoneNumber : phoneNumber, address: address, picture :downloadUrl, star:star
        }
      )
  ...
  const updateContact = async () => {
    ...
    try {
      firebase.database().ref('contacts/ ' + contactToUpdate).set(
        {
          name: name, email :email, phoneNumber : phoneNumber, address: address, picture :downloadUrl, star:star
        }
      )
